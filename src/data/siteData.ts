...
export const honditImages = {
  homeHero: "/images/hondit-jeju-dawn-hero-v2.webp",
  homeStoneHero: "/images/hondit-hero.webp",
  fullLineReal: "/images/hondit-collection-hero.webp",
  fullLineShipping: "/images/hondit-collection-hero.webp",
  cleansingTrio: "/images/hondit-cleansing-trio.webp",
  diffuserPair: "/images/hondit-diffuser-detail.webp",
  diffuser350Studio: "/images/diffuser-350g.webp",
  diffuser350Window: "/images/diffuser-350g.webp",
  diffuser350Stone: "/images/hondit-diffuser-detail.webp",
  diffuser350Shelf: "/images/hondit-diffuser-detail.webp",
  diffuser500Studio: "/images/diffuser-500g.webp",
  diffuser500Window: "/images/diffuser-500g.webp",
  diffuser500Wood: "/images/hondit-hero.webp",
  foamingCutout: "/images/foaming-cleanser.webp",
  foamingPack: "/images/foaming-cleanser.webp",
  foamingLifestyle: "/images/hondit-cleansing-trio.webp",
  foamOil: "/images/foam-oil.webp",
  cleansingWaterPack: "/images/cleansing-water.webp",
  cleansingWaterCutout: "/images/cleansing-water.webp",
  jejuHero: "/images/jeju-field-sea.webp",
  jejuSea: "/images/jeju-field-sea.webp",
  jejuWind: "/images/jeju-wind-coast-v2.webp",
  jejuStone: "/images/jeju-water-basalt-v2.webp",
  jejuForest: "/images/jeju-field-bijarim.webp",
  jejuWall: "/images/jeju-field-jusangjeolli.webp",
  jejuUniversity: "/images/jnu-campus.webp",
};
...
export const cleansingProducts: Product[] = [
  {
    ...
    category: "MAKEUP & SUNSCREEN",
    size: "150ml",
    description: "One-step cleansing for makeup, sunscreen and daily buildup.",
  ...
  },
  {
    ...
    category: "DAILY FACE WASH",
    size: "200ml",
    description: "A soft everyday wash for a fresh, comfortable finish.",
  ...
  },
  {
    ...
    category: "QUICK & GENTLE CLEANSE",
    size: "300ml",
    description: "Lightweight cleansing for quick resets and light makeup.",
...
export const diffuserProducts: Product[] = [
  {
    ...
    category: "FLAMELESS VOLCANIC SCENT",
    size: "500g",
    description: "Jeju volcanic scoria scent object for larger rooms.",
  ...
  },
  {
    ...
    category: "FLAMELESS VOLCANIC SCENT",
    size: "350g",
    description: "Compact Jeju volcanic scoria scent for small spaces.",
