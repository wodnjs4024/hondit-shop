...
export type BulkProduct = {
  ...
  marketUnitPrices?: Partial<Record<"SG" | "HK" | "TW" | "JP" | "BN" | "MO" | "TH" | "MY", number>>;
};
...
export const bulkProducts: BulkProduct[] = [
  ...
  },
  {
    ...
    unitPriceSgd: 21,
    marketUnitPrices: { SG: 21, HK: 128, TW: 480, JP: 2400, BN: 21, MO: 128, TH: 550, MY: 68 },
    packQuantity: 20,
    packPriceSgd: 420,
    unitWeightKg: 0.48,
    inventoryPacks: 12,
  ...
  },
  {
    ...
    unitPriceSgd: 46,
    marketUnitPrices: { SG: 46, HK: 280, TW: 1050, JP: 5200, BN: 46, MO: 280, TH: 1200, MY: 148 },
    packQuantity: 20,
    packPriceSgd: 920,
    unitWeightKg: 0.68,
    inventoryPacks: 10,
...
export const livePaymentTestProduct: BulkProduct = {
  ...
  imageUrl: packImages.diffuser350Studio,
  unitPriceSgd: 1,
  marketUnitPrices: { SG: 1, HK: 6, TW: 25, JP: 120, BN: 1, MO: 6, TH: 26, MY: 3.2 },
  packQuantity: 1,
  packPriceSgd: 1,
  unitWeightKg: 0,
  inventoryPacks: 1,
